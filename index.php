...
<body data-bs-spy="scroll" data-bs-target="#navbarExample">
        ...
        <div class="container">
            ...
            <div class="navbar-collapse offcanvas-collapse" id="navbarsExampleDefault">
                <ul class="navbar-nav ms-auto navbar-nav-scroll">
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="index.php?menu=beranda">Beranda</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="index.php?menu=jasa">Jasa</a>d
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="index.php?menu=proyek">Proyek</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="index.php?menu=visi_misi">Visi & Misi</a>
                    </li>
                    <li class="nav-item">
    ...
    <!-- Header -->
        <?php 
            ...
            elseif ($_GET ['menu'] == 'proyek') {
                include "proyek.php";
            }
            elseif ($_GET ['menu'] == 'visi_misi') {
    ...
    <div class="copyright bg-gray">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6">
                    <p class="p-small statement">Copyright © <a href="#">CV. Stowr 2021</a></p>
                </div> <!-- end of col -->
            </div> <!-- enf of row -->
        </div> <!-- end of container -->
